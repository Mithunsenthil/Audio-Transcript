...
SUPPORTED_MODELS = ["tiny", "base"]  # Add more models if required
...
def reset_session_state():
    for key in ["audio_file_path", "last_processed_file", "transcription", "transcribed", "downloaded"]:
        ...
        with input_container.container():
            ...
            if audio_source == "Upload File":
                ...
                if uploaded_file is not None and uploaded_file.name != st.session_state.last_processed_file:
                    audio_file_path = os.path.join(tmpdirname, uploaded_file.name)
